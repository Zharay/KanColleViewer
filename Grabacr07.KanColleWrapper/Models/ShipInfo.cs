...
namespace Grabacr07.KanColleWrapper.Models
{
    ...
    public class ShipInfo : RawDataWrapper<kcsapi_mst_ship>, IIdentifiable
    {
        ...
        public string Name
        {
            get { return KanColleClient.Current.Translations.GetTranslation(RawData.api_name, TranslationType.Ships, this.RawData); }
        }
		...
		public string UntranslatedName {
			get { return this.Name != RawData.api_name ? RawData.api_name : ""; }
		}
